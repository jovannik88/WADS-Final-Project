...
import { Users, BarChart3, Bell, Bot, LogOut, ShieldCheck, Menu } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#080d12] text-white flex">
      ...
      <div className="hidden md:flex flex-col fixed left-0 top-0 h-full w-64 z-40">
        <AdminSidebar pathname={pathname} onClose={() => {}} onLogout={handleLogout} />
      </div>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-64">
            <AdminSidebar pathname={pathname} onClose={() => setMobileOpen(false)} onLogout={handleLogout} />
          </div>
        </div>
      )}
